...
def build_domain_index(domain_name, domain_dir):
    ...
    dense_enabled = ENABLE_DENSE and faiss is not None
    if ENABLE_DENSE and faiss is None:
        print("[WARN] FAISS is unavailable; building sparse/BM25 index only.")
    ...
    if dense_enabled:
        ...
        print("FAISS: skipped (dense retrieval disabled or unavailable)")
